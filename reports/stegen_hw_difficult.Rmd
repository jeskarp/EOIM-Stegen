...
Alternatively, you can also view your dataset by clicking on **tira_data** in the top right "global environment" panel of your *R studio* browser.  Your global environment is where you can see all the datasets, functions and other things you have loaded in the current session. 
...
tira_data$agegroup <- findInterval(tira_data$age, c(0,30,150)) - 1
...
vars <- colnames(tira_data[,c(8:10,12:21)]) 
