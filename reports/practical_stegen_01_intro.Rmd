...
# Recoding missing data and creating new variables
...
### e) Create a new age group variable with 2 groups (<30 and >=30)

### f) Save your new dataset
As a csv file named **tira_clean**.

\newpage
# Help

### a) Install and load the required packages and functions for this practical
...
You can create a new age group variable using one of the following approaches:
